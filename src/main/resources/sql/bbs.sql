...
CREATE TABLE IF NOT EXISTS user(
    ...
    user_job VARCHAR(30) NOT NULL COMMENT '用户职业',
    user_job_place VARCHAR(30) NOT NULL COMMENT '用户工作地点',
...
CREATE TABLE IF NOT EXISTS post(
    ...
    post_status INT(2) NOT NULL default '0' COMMENT '帖子状态:0:正常 1:置顶 2：加精 3：置顶和加精',
